		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div id="costBasicInfo">
					<div class="row">
						<div class="col-xs-3">
							<div><img src="" style="width:200px;" id="model-photo"></div>
						...
						<div class="col-xs-8">
							<table class="table table-condensed" style="width:700px;">
								...
								<tr>
									...
									<td id="modal-note"><pre class="pre-scrollable" style="width:400px;height:210px;"></pre></td>
								</tr>
							</table>
						</div>
					</div>
