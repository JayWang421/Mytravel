					...
					<form class="form-horizontal" action="<%=EMP_EDIT_URL%>" id="myform" method="post" enctype="multipart/form-data">
						<fieldset>
							...
							<div class="form-group" id="eidDiv">
								...
								<div class="col-md-5">
									...
									<input type="text" id="eid" name="eid" class="form-control"
										placeholder="请输入雇员登录ID" value="${emp.eid}" readonly="readonly">
								</div>
								<!-- 定义表单错误提示显示元素 -->
							...
							<div class="form-group" id="salDiv">
								<!-- 定义表单提示文字 -->
								<label class="col-md-3 control-label" for="sal">工资：</label>
								<div class="col-md-5">
									<!-- 定义表单输入组件 -->
									<input type="text" id="sal" name="sal" class="form-control"
										placeholder="请输入雇员工資" value="${emp.sal}">
								</div>
								<!-- 定义表单错误提示显示元素 -->
								...
								<div class="col-md-5">
									<select id="lid" name="lid" class="form-control">
										...
										<c:forEach items="${allLevels}" var="lev">
											<option value="${lev.lid}" ${lev.lid==emp.lid ? "selected" : ""}>${lev.title}</option>
										</c:forEach>
									</select>
								</div>
								<!-- 定义表单错误提示显示元素 -->
							...
							<div class="form-group" id="picDiv">
								...
								<div class="col-md-5">
									<img src="upload/member/${emp.photo}"><br>
									<!-- 定义表单输入组件 -->
							...
							<div class="form-group">
								<div class="col-md-5 col-md-offset-3">
									<input type="hidden" id="pic" value="${emp.photo}">
									<input type="hidden" id="lid" value="${emp.lid}">
