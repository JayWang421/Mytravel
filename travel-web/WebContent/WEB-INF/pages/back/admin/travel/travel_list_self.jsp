...
<%!
	...
	public static final String TRAVEL_COST_URL = "pages/back/admin/travel/add_cost_pre.action" ;
%>
						...
						<c:forEach items="${allTravels}" var="travel">
							<tr id="travel-1">
								...
								<td class="text-center">
									...
									<a type="button" class="btn btn-warning btn-xs" href="<%=TRAVEL_COST_URL%>?tid=${travel.tid}">
