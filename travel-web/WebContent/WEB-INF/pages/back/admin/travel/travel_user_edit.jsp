		...
		<div class="content-wrapper text-left">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<table class="table table-condensed" id="addEmpTable">
						<thead>
							<tr>
						...
						<tbody>
							<c:forEach items="${allEmps}" var="emp">
								<tr id="travel-${tid}">
									...
									<td class="text-center">${levelMap[emp.lid]}</td>
									<td class="text-center">${deptMap[emp.did]}</td>
									<td class="text-center">
										<button class="btn btn-danger btn-xs" id="remove-${tid}">
