...
<%!
	public static final String TRAVEL_COST_URL = "pages/back/admin/travel/add_cost.action" ;
%>
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="form-group" id="didDiv">
					<h3><strong><span class="glyphicon glyphicon-eye-open"></span>&nbsp;增加差旅支出申请项</strong></h3>
				</div>
			</div>
