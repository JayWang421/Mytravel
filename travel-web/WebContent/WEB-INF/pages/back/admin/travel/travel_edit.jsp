	...
	<div class="wrapper">
		...
		<div class="content-wrapper text-left">
				...
				<div class="panel-body">
					<form class="form-horizontal" action="<%=TRAVEL_EDIT_URL%>?tid=${travel.tid}" id="myform" method="post">
						<fieldset>
							...
							<div class="form-group" id="sdateDiv">
								...
								<div class="col-md-5">
									...
									<input type="text" id="sdate" name="sdate" class="form-control"
										placeholder="请选择出差开始时间" value="<fmt:formatDate value="${travel.sdate}" type="date"/>" readonly="readonly">
								</div>
								<!-- 定义表单错误提示显示元素 -->
							...
							<div class="form-group" id="edateDiv">
								...
								<div class="col-md-5">
									...
									<input type="text" id="edate" name="edate" class="form-control"
										placeholder="请选择出差结束时间"  value="<fmt:formatDate value="${travel.edate}" type="date"/>" readonly="readonly">
								</div>
								<!-- 定义表单错误提示显示元素 -->
							...
							<div class="form-group" id="destDiv">
								...
								<div class="col-md-5">
									...
									<input type="text" id="dest" name="dest" class="form-control"
										placeholder="请填写本次出差的目的地" value="${travel.dest}">
								</div>
								<!-- 定义表单错误提示显示元素 -->
